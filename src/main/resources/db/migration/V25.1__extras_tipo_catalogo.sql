...
ALTER TABLE archivo_modulo
    MODIFY COLUMN tipo_catalogo_producto ENUM('BASICO', 'COMIDA', 'DESAYUNO', 'EXTRAS') NULL;

ALTER TABLE archivo
    MODIFY COLUMN entity_type ENUM('BASICO', 'COMIDA', 'DESAYUNO', 'EXTRAS') NULL;
