...
ALTER TABLE archivo
    MODIFY COLUMN entity_type
        ENUM('BASICO','COMIDA','COMPLEMENTO','DESAYUNO','SNACK','CHAROLA','BEBIDA') NOT NULL;

ALTER TABLE archivo_modulo
    MODIFY COLUMN tipo_catalogo_producto
        ENUM('BASICO','COMIDA','COMPLEMENTO','DESAYUNO','SNACK','CHAROLA','BEBIDA') NULL;
